...
public class DeveloperRepositoryTests {
    ...
    public void givenThreeDevelopersAndTwoAreActive_whenFindAllActiveBySpeciality_thenOnlyTwoDevelopersAreReturned() {
        //given
        DeveloperEntity developer1 = DataUtils.getJohnDoeTransient();
        DeveloperEntity developer2 = DataUtils.getMikeSmithTransient();
        DeveloperEntity developer3 = DataUtils.getFrankJonesTransient();
        developerRepository.saveAll(List.of(developer1, developer2, developer3));
        //when
        List<DeveloperEntity> obtainsDevelopers = developerRepository.findAllActiveBySpecialty("Java");
        //then
        assertThat(CollectionUtils.isEmpty(obtainsDevelopers)).isFalse();
        assertThat(obtainsDevelopers.size()).isEqualTo(2);
    }
